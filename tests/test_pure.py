# ruff: noqa: I001
#
# I001 (порядок импортов) отключаем здесь точечно: ruff в CI не всегда
# распознаёт `main` как first-party-модуль (no proper package structure),
# из-за чего ругается и на сгруппированную, и на склеенную версию.
# Файл маленький и состоит из двух импортов — стилистика тут не важна.
"""
